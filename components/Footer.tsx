...
export function Footer() {
  ...
  return (
    <footer className="relative overflow-hidden bg-cream-warm border-t border-surface-border">
        ...
        <div className="pt-40 pb-12">
            ...
            <div className="lg:col-span-4">
              <Link href="/" className="group inline-flex items-center gap-3 mb-5">
                ...
                <div className="flex flex-col">
                  ...
                  <span className="text-[9px] uppercase tracking-[0.3em] text-ink-muted font-accent font-medium">Private Theatre</span>
                </div>
              </Link>
              ...
              <div className="mt-6 flex gap-2">
                {[
                  ...
                  <motion.a
                    ...
                    whileTap={{ scale: 0.95 }}
                    className="flex h-9 w-9 items-center justify-center rounded-lg bg-surface border border-surface-border text-ink-muted transition-all hover:text-burgundy hover:border-burgundy/30 hover:bg-burgundy-bg"
              ...
              <div className="mt-6 inline-flex items-center gap-2 rounded-xl bg-surface border border-surface-border px-4 py-2.5">
                <div className="flex">
                  {[1, 2, 3, 4, 5].map((star) => (
                    <Star key={star} className={`h-3.5 w-3.5 ${star <= 4.9 ? 'text-amber fill-amber' : 'text-ink-light'}`} />
                  ))}
                </div>
                <div className="text-left">
                  <p className="text-xs font-semibold text-ink leading-tight">4.9 Rating</p>
                  <p className="text-[10px] text-ink-muted leading-tight">12,000+ celebrations</p>
                </div>
              </div>
            </div>
              ...
              <ul className="space-y-2.5">
                {footerLinks.navigate.map((link) => (
                  <li key={link.href}>
                    <Link 
                      href={link.href}
                      className="group inline-flex items-center gap-1.5 text-sm text-ink-secondary transition hover:text-burgundy"
                    >
                      <ChevronRight className="h-3 w-3 text-ink-light transition-all group-hover:translate-x-0.5 group-hover:text-burgundy" />
                      {link.label}
                    </Link>
                  </li>
                ))}
            ...
            <div className="lg:col-span-3">
              ...
              <ul className="space-y-3.5">
                ...
                <li className="flex items-center gap-3">
                  ...
                  <a href="tel:+919876543210" className="text-sm text-ink-secondary transition hover:text-burgundy">
                    +91 98765 43210
                  </a>
                </li>
                <li className="flex items-center gap-3">
                  ...
                  <a href="mailto:hello@cinehaven.com" className="text-sm text-ink-secondary transition hover:text-burgundy">
                    hello@cinehaven.com
                  </a>
                </li>
                <li className="flex items-center gap-3">
          ...
          <div className="flex flex-col items-center justify-between gap-4 md:flex-row">
            ...
            <div className="flex gap-6">
              <Link href="/privacy" className="text-xs text-ink-muted transition hover:text-burgundy">
                Privacy Policy
              </Link>
              <Link href="/terms" className="text-xs text-ink-muted transition hover:text-burgundy">
                Terms of Service
              </Link>
              <Link href="/sitemap" className="text-xs text-ink-muted transition hover:text-burgundy">
                Sitemap
              </Link>
            </div>
          </div>
